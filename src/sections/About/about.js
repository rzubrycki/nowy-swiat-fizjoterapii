  ...
  return (
    <Layout>
      ...
      <article>
        ...
        <p>
          Doświadczenie zawodowe zdobyłam pracując z pacjentami ortopedycznymi,
          pourazowymi oraz sportowcami. Dodatkowo miałam możliwość pracy
          pedagogicznej, jako nauczyciel przedmiotów zawodowych w Szkole
          Policealnej kształcącej przyszłych masażystów.
        </p>
        <p>
        ...
        <p>
          ...
          konferencji "Osteoporoza - choroba cywilizacyjna XXI wieku - aktualne
          aspekty profilaktyki, leczenia i rehabilitacji".
        </p>
        <p>
        ...
        <div className="dialogButtons">
          <button onClick={() => handleOpenModal(1)}>Przebyte Kursy</button>
        </div>
      </article>
      <Modal
        isOpen={modalIsOpen}
        ...
        ariaHideApp={false}
      >
        <CoursesModal close={handleCloseModal} />
      </Modal>
    </Layout>
  )
}
